...
<section id="formNewContact" class="relative w-full mx-auto py-16 z-0 overflow-hidden bg-white">
    ...
    <div class="z-10 grid grid-cols-1 py-12 justify-center mx-auto w-11/12 px-4 rounded-4xl bg-white mt-3 shadow-2xl">
        <h5 class="text-center text-5xl mt-8 mb-8 lg:mb-16">Contact us</h5>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="w-full grid grid-cols-1 justify-center mx-auto lg:mx-0">
                <form class="mx-auto w-full" action="{{ route('new_contact') }}" method="POST">
                    @csrf
                    <div class="mx-auto grid w-11/12 lg:w-5/6">
                    ...
                    <div class="flex gap-3 w-11/12 lg:w-5/6 justify-self-center">
